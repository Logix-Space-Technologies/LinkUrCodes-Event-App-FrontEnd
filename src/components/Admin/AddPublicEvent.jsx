...
const AddPublicEvent = () => {
    ...
    const readValues=()=>{
        axios.post("http://localhost:8085/api/events/add_public_events",input, {}, { headers: { token: sessionStorage.getItem("admintoken") } }).then(
            (response)=>{
      ...
      <div className="container">
                <div className="row g-3">
                    ...
                    <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        ...
                        <input type="file" className="form-control" name='event_public_image' value={input.event_public_image} onChange={inputHandler} />
                    </div>
                    <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <label htmlFor="syllabus" className="form-label">Event Syllabus</label>
                        <input type="text" className="form-control" name='event_public_syllabus' value={input.event_public_syllabus} onChange={inputHandler} />
                    </div>
                    <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
                        <label htmlFor="venue" className="form-label">Event Venue</label>
                        <input type="text" className="form-control" name='event_public_venue' value={input.event_public_venue} onChange={inputHandler} />
                    </div>
                    <div className="col col-12 col-sm-6 col-md-6 col-lg-6 col-xl-6 col-xxl-6">
